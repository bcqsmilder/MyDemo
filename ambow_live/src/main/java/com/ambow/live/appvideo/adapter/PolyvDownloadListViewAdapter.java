...
import com.ambow.live.appvideo.database.PolyvDownloadSQLiteHelper;
import com.ambow.live.bean.PolyvDownloadInfo;
import com.ambow.live.utils.PolyvErrorMessageUtils;
...
//                Toast.makeText(appContext, message, Toast.LENGTH_LONG).show();
    ...
    private class DownloadOnClickListener implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            if (tv_status.getText().equals(DOWNLOADED)) {
                mPolyvDownloadListViewClicking.onItemClick( vid, bitrate, true, true, fileType);
...
//                intent.putExtra("isVlmsOnline", false);
//                context.startActivity(intent);
    ...
    PolyvDownloadListViewClicking mPolyvDownloadListViewClicking;

    public void setmPolyvDownloadListViewClicking(PolyvDownloadListViewClicking mPolyvDownloadListViewClicking) {
        this.mPolyvDownloadListViewClicking = mPolyvDownloadListViewClicking;
    }

    public interface PolyvDownloadListViewClicking{
        void onItemClick(String vid, int bitrate, boolean startNow,boolean isMustFromLocal,int fileType);
    }
}
