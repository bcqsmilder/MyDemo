...
import com.ambow.live.utils.PolyvClipboardUtils;
import com.ambow.live.utils.PolyvRoundDisplayerUtils;
import com.ambow.live.utils.PolyvTextImageLoader;
import com.ambow.live.utils.PolyvTimeUtils;
import com.ambow.live.utils.PolyvVlmsHelper;
import com.ambow.live.widget.LinearListView;
        ...
        if (polyvAnswers.size() > 0) {
            ...
            viewHolder.sublv_talk.setOnItemClickListener(new LinearListView.OnItemClickListener() {
                ...
                public void onItemClick(LinearListView parent, View view, int position, long id) {
                    ...
                    toActivityListening.toActivity(polyvQuestion.question_id,pPosition,polyvQuestion.nickname);
...
//                    context.startActivityForResult(intent, 13);
    ...
    public toActivityListening toActivityListening;

    public void setToActivityListening(PolyvTalkListViewAdapter.toActivityListening toActivityListening) {
        this.toActivityListening = toActivityListening;
    }


    public interface  toActivityListening{
        // context.startActivityForResult(intent, 13);
        void toActivity(String question_id,int position,String nickname);
    }
